...
file_put_contents('C:/xampp/htdocs/sleepwell_coffeeshop/php/debug.log', 
    "appetizer.php accessed at " . date('Y-m-d H:i:s') . "\n" .
...
<head>
    ...
    <title>Appetizer Menu - Sleep Well Coffee Shop</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="dashboard">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="/sleepwell_coffeeshop/php/appetizer.php" class="nav-link active">Appetizer</a></li>
        ...
        <div class="content">
            ...
            <div class="category-filter">
                ...
                <a href="/sleepwell_coffeeshop/php/beverage.php">Beverage</a>
                <a href="/sleepwell_coffeeshop/php/appetizer.php" class="active">Appetizer</a>
            </div>
            <div class="menu-grid" id="menu-grid">
                <?php
                $result = $conn->query("SELECT * FROM menu_items WHERE category = 'appetizer' ORDER BY name") or die("Query failed: " . $conn->error);
                if ($result->num_rows == 0) {
                    echo "<p class='no-items'>No items available</p>";
                } else {
                    while ($item = $result->fetch_assoc()) {
                        echo "<div class='menu-item' data-category='appetizer'>";
                        echo "<h3>" . htmlspecialchars($item['name']) . "</h3>";
                        echo "<p>Category: Appetizer</p>";
