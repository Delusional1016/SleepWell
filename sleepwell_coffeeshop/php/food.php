...
file_put_contents('C:/xampp/htdocs/sleepwell_coffeeshop/php/debug.log', 
    "food.php accessed at " . date('Y-m-d H:i:s') . "\n" .
...
<head>
    ...
    <title>Food Menu - Sleep Well Coffee Shop</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="dashboard">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="/sleepwell_coffeeshop/php/food.php" class="nav-link active">Food</a></li>
        ...
        <div class="content">
            ...
            <div class="category-filter">
                ...
                <a href="/sleepwell_coffeeshop/php/food.php" class="active">Food</a>
                <a href="/sleepwell_coffeeshop/php/beverage.php">Beverage</a>
                <a href="/sleepwell_coffeeshop/php/appetizer.php">Appetizer</a>
            </div>
            <div class="menu-grid" id="menu-grid">
                <?php
                $result = $conn->query("SELECT * FROM menu_items WHERE category = 'food' ORDER BY name") or die("Query failed: " . $conn->error);
                if ($result->num_rows == 0) {
                    echo "<p class='no-items'>No items available</p>";
                } else {
                    while ($item = $result->fetch_assoc()) {
                        echo "<div class='menu-item' data-category='food'>";
                        echo "<h3>" . htmlspecialchars($item['name']) . "</h3>";
                        echo "<p>Category: Food</p>";
