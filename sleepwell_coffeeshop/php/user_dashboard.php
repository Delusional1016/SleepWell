...
file_put_contents('C:/xampp/htdocs/sleepwell_coffeeshop/php/debug.log', 
    "user_dashboard.php accessed at " . date('Y-m-d H:i:s') . "\n" .
...
<head>
    ...
    <title>Menu - Sleep Well Coffee Shop</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="dashboard">
        <div class="sidebar">
            ...
            <ul>
                <li><a href="/sleepwell_coffeeshop/php/user_dashboard.php" class="nav-link active">View Menu</a></li>
        ...
        <div class="content">
            ...
            <div class="category-filter">
                <a href="/sleepwell_coffeeshop/php/user_dashboard.php" class="active">View All</a>
            ...
            <div class="menu-grid" id="menu-grid">
                <?php
                $result = $conn->query("SELECT * FROM menu_items ORDER BY name") or die("Query failed: " . $conn->error);
                if ($result->num_rows == 0) {
                    ...
                    while ($item = $result->fetch_assoc()) {
                        ...
                        echo "<p>Category: " . ucfirst(htmlspecialchars($item['category'])) . "</p>";
